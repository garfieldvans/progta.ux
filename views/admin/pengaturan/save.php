...
<?php
	...
	/*if(empty($op)){
		$sql = mysqli_query("INSERT INTO tbl_dosen (id_dosen, nama_dosen) VALUES ('$id_dosen','$nama_dosen')");
	}
	else{
		$sql = mysqli_query("UPDATE tbl_dosen SET nama_dosen='$nama_dosen' WHERE id_dosen='$id_dosen'");
	}*/
	...
	if($pass_lama=="" || $pass_baru=="" || $ulang_pass_baru==""){
		...
		$sql = mysqli_query($koneksi, "UPDATE tbl_admin SET password='$ulang_pass_baru' WHERE username='$cek_user'");
